...
## 范围
- `lib/services/scripts/orchestrator.ts`
- `tests/unit/scripts-orchestrator.test.ts`
...
## 过滤命令
```
pnpm exec tsc --noEmit 2>&1 | grep -E "scripts/orchestrator\.ts|scripts-orchestrator\.test\.ts"
```
输出：（空）
